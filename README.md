...
- **Status:** Published
- **Author:** Nate Scott
- **Date:** 2026-06-18 (Upgrade Center and AI-First policy gates)
...
- **AI-First Readiness And Evidence:** Admin APIs for readiness snapshots, GitHub/verification signals, evidence packs, and policy-derived gates that combine graph, indexing, ADC, governance, and work activity signals.
