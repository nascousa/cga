...
This contract is observe/warn in `1.30.101`. Current policy gates report saved evidence, CI, PR/review, benchmark, and Work Briefing status without blocking actions; future policy profiles can promote missing evidence from a warning to an enforced review gate.